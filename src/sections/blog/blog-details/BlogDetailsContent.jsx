      ...
      <div className="single-blog-post">
        ...
        <div className="post-content">
          ...
          <ul className="post-list flex items-center gap-4 sm:gap-6 lg:gap-8 mb-5 pb-5 border-b border-gray-200 flex-wrap">
            <li className="flex items-center gap-2 text-white font-['Roboto',sans-serif] text-sm sm:text-base font-medium">
          ...
          {/* Title */}
          <h3 className="text-white font-['Epilogue',sans-serif] text-2xl sm:text-3xl lg:text-4xl font-bold mb-5">
          ...
          <p className="text-text font-['Roboto',sans-serif] text-base leading-7 mb-5">
          ...
          {/* Highlighted Text */}
          <div className="hilight-text border-l-4 border-theme p-6 sm:p-8 lg:p-10 bg-white rounded-lg my-12 sm:my-5 relative">
