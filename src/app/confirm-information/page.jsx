...
// Lazy load ConfirmPasswordSection - Heavy component with API calls
const ConfirmPasswordSection = dynamic(
  () => import("../../components/pages/confirm-information/ConfirmPasswordSection"),
  {
