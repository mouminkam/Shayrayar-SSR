                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-4 sm:gap-6">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                    ...
                    <div className="col-md-6">
                      <input
                        ...
                        className="w-full px-4 sm:px-5 py-3 sm:py-4 rounded-lg border border-gray-200 text-text font-['Roboto',sans-serif] text-sm sm:text-base focus:outline-none focus:border-theme transition-colors duration-300"
                        required
                      />
                    </div>
                  ...
                  <div className="col-12">
                    <textarea
                      ...
                      onChange={handleChange}
                      className="w-full px-4 sm:px-5 py-3 sm:py-4 rounded-lg border border-gray-200 text-text font-['Roboto',sans-serif] text-sm sm:text-base resize-y focus:outline-none focus:border-theme transition-colors duration-300"
                      required
                    ></textarea>
                  </div>
                  ...
                  <div className="col-12 form-group flex items-start gap-3">
                    <input
                      ...
                      onChange={handleChange}
                      className="mt-1.5 w-5 h-5 rounded border-gray-300 text-theme focus:ring-theme cursor-pointer"
                      required
                    />
                    <label
                      htmlFor="reviewcheck"
                  ...
                  <div className="col-12 form-group mb-0">
                    <button
                      type="submit"
                      className="theme-btn w-full bg-theme text-white px-6 sm:px-8 py-3 sm:py-4 rounded-none font-['Roboto',sans-serif] text-sm sm:text-base font-medium hover:bg-theme2 transition-colors duration-300 flex items-center justify-center gap-2"
                    >
                      SUBMIT NOW
