...
export default function BlogSection() {
  ...
  return (
    <section className="blog-section py-12 sm:py-16 md:py-20 lg:py-24 relative overflow-hidden">
      <div className="blog-wrapper style3 -mt-[30px]">
        <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-12">
          {/* First Row */}
          {firstRow.length > 0 && (
            <div className="blog-card-wrap style3 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
              {firstRow.map((blog, index) => (
              <div
                key={index}
                className="blog-card style1 bg-white rounded-3xl overflow-hidden shadow-lg transition-all duration-300 hover:-translate-y-2 hover:shadow-xl group"
              >
                {/* Image */}
          ...
          {/* Second Row */}
          {secondRow.length > 0 && (
            <div className="blog-card-wrap style3 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 mt-8">
